import { ExtendedFab, Layout } from '../components';
...
const meta = {
  title: 'About Wildberries',
  description: 'A dark theme for purple lovers',
  image: 'https://wildberries.style/api/og',
};
      ...
      <Layout meta={meta}>
        ...
        <div>
          <div className="mx-auto max-w-6xl rounded-b-lg px-6 py-10 text-lg leading-8 backdrop-blur-sm sm:px-6 md:px-16">
            ...
            <p>
              Being just a developer and not a graphic designer, I came up with this color scheme by pure personal
              taste, however, by time passing and many applications being customized, I tried to follow some
              consistencies.
            </p>
